...
class Datadrivendesign_Knowledgebase_Helper_Scribd extends Mage_Core_Helper_Abstract
{
	...
	public function __construct($api_key, $secret) {
		$api_key = "3w5es6bdqe7bb08e90rwu";
		$secret = "sec-ahedzdpq6br13ifsq678qqj2zs";
		$url = "http://api.scribd.com/api?api_key=";
   ...
   */
	public function search($query, $num_results = null, $num_start = null, $scope = null){
	  ...
	  /**
   * Get all base level categories
   */
	/*public function collections(){
		$method = "collections.getList";
